...
print(f"##### PAPER KEY WORDS ######")
print(key_word_text)
print(f"#####                 ######")

# Paper Search
paper_results = arxiv.Search(query=key_word_text)
print(f"##### PAPER SELECTION ######")
...
with open("data/basis.txt", "w") as file:
